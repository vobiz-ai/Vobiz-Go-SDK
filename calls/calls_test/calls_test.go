...
func TestCallsMakeCallWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Calls.MakeCall(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestCallsMakeCallWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestCallsMakeCallWithWireMock", "POST", "/api/v1/Account/MA_XXXXXX/Call/", nil, 1)
}
