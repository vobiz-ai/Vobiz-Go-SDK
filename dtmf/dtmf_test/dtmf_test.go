...
func TestDtmfSendDtmfWithWireMock(
	t *testing.T,
) {
	...
	invocationErr := client.Dtmf.SendDtmf(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestDtmfSendDtmfWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestDtmfSendDtmfWithWireMock", "POST", "/api/v1/Account/MA_XXXXXX/Call/call_uuid/DTMF/", nil, 1)
}
