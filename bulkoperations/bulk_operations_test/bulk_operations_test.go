...
func TestBulkOperationsBulkExportRecordingsWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.BulkOperations.BulkExportRecordings(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestBulkOperationsBulkExportRecordingsWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestBulkOperationsBulkExportRecordingsWithWireMock", "POST", "/api/v1/Account/MA_XXXXXX/export/recording/", nil, 1)
}
